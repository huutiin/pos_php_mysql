    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td class="th-title">
                        <?php foreach ($thoigianca1 as $key => $value) {
                            echo $value["tenthoigianca"] . ' (' . $value["thoigianstar"] . ' - ' . $value["thoigianend"] . ')';
                        } ?>
                    </td>
                    <td>
                        <input type="checkbox" name="" id=""> Btrung </input>
                        <br>
                        <input type="checkbox" name="" id=""> Btrung2 </input>
                    </td>
                    <td><input type="checkbox" name="" id=""> Btrung </input>
                        <br>
                        <input type="checkbox" name="" id=""> Btrung2 </input>
                    </td>
                    <td><input type="checkbox" name="" id=""> Btrung </input>
                ...
                <tr>
                    <td class="th-title">
                        <?php foreach ($thoigianca2 as $key => $value) {
                            echo $value["tenthoigianca"] . ' (' . $value["thoigianstar"] . ' - ' . $value["thoigianend"] . ')';
                        } ?>
                    </td>
                    <td><input type="checkbox" name="" id=""> Btrung </input>
                ...
                <tr>
                    <td class="th-title">
                        <?php foreach ($thoigianca3 as $key => $value) {
                            echo $value["tenthoigianca"] . ' (' . $value["thoigianstar"] . ' - ' . $value["thoigianend"] . ')';
                        } ?>
                    </td>
                    <td><input type="checkbox" name="" id=""> Btrung </input>
                ...
                <tr>
                    <td class="th-title">
                        <?php foreach ($thoigiancaht as $key => $value) {
                            echo $value["tenthoigianca"] . ' (' . $value["thoigianstar"] . ' - ' . $value["thoigianend"] . ')';
                        } ?>
                    </td>
                    <td><input type="checkbox" name="" id=""> Btrung </input>
        ...
        <input style="float: right;" class="btn-primary btn" type="submit" value="Xác nhận">
        </form>
    </div>
</body>
